  ...
  <ul class="subjects">
      <?php while($nav_subject =
       mysqli_fetch_assoc($nav_subjects)){ ?>
        ...
        <a href="<?php echo $path."index.php?subject_id=".h(u($nav_subject['id'])) ;?>">
